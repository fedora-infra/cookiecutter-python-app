...
copyright = "{{ cookiecutter.__year }}, Contributors to the Fedora Project"
author = "Fedora Infrastructure"

# The short X.Y version
version = ".".join({{ cookiecutter.pkg_name }}.__version__.split(".")[:2])
...
def run_apidoc(_):
    ...
    apidoc.main(
        [
            ...
            # exclude patterns:
            os.path.join(topdir, "{{ cookiecutter.pkg_name }}", "migrations"),
        ]
    )
